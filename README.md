...
This project presents an interactive Credit Card Analytics Dashboard developed using Power BI.
The dashboard provides deep insights into customer behavior, transaction patterns, revenue generation, and interest earnings for a credit card business.
It helps stakeholders understand which customer segments and transaction types contribute most to revenue and supports data-driven decision making.
